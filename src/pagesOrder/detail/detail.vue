...
import type { OrderPreResult, OrderResult, OrderLogisticResult, LogisticItem } from '@/types/order'
...
onReady(() => {
  ...
  //动画效果 导航栏返回按钮
  pageInstance.animate('.navbar .back', [{ color: 'transparent' }, { color: '#000' }], 1000, {
    scrollSource: '#scroller',
    timeRange: 2000,
    startScrollOffset: 0,
    endScrollOffset: 100,
...
const onOrderConfirm = () => {
  uni.showModal({
    content: '为保障您的收益，请收到货并确认 无误后，再确认收货',
